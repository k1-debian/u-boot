 ...
 * MA 02111-1307 USA
 */
#ifndef __CREALITYK1__
#define __CREALITYK1__
...
#define CONFIG_BOOTARGS_AUTO_MODIFY	1	/*auto detect memory size, and modify bootargs for kernel.*/
	...
	#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS2,115200 ieee754=relaxed "
#else
	#define BOOTARGS_COMMON LINUX_LOGLEVEL " console=ttyS2,115200 mem=128M@0x0 ieee754=relaxed "
#endif


#if defined(CONFIG_JZ_MMC_MSC0)
	#define MSC_BOOTARGS " rootfstype=ext4 root=/dev/mmcblk0p4 rootdelay=3 rw"
#elif defined(CONFIG_JZ_MMC_MSC2)
	#define MSC_BOOTARGS " rootfstype=ext4 root=/dev/mmcblk2p4 rootdelay=3 rw"
#endif
